                ...
                <div class="col-sm-8">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                      <div>
                        <button type="button" class="btn btn-lg btn-primary btn-margin" id="btn1">Student</button>
                        <button type="button" class="btn btn-lg btn-warning" id="btn2">Instructor</button>
                      </div>
...
<!-- Responsive calendar - END --></div>
                                ...
                                <div class="col-sm-12">
									<ul class="nav nav-tabs nav-justified">
										...
										<li><a href="#indivisual-result" data-toggle="tab"><span class="glyphicon glyphicon-zoom-in"></span> <b>Indivisual results</b></a></li>
									</ul>
                                    </div>
							<div class="col-sm-12" >
								<div class="tab-content" style="border:0;">
                                   ...
                                   &nbsp View as : <select class="selectpicker" data-width="140px" id="view-result-type">
                                    ...
                                    <div class="tab-pane fade" id="indivisual-result">
								      <!-- -------------------- -->
                                    ...
                                    <button type="button" class="btn btn-md btn-success" id="result-btn" onclick="viewIndivisualResult()">View</button>
                                     <div id="indivisual-result-graph"></div>
								...
								<div class="tab-pane fade wrapper" id="postquiz">
                                   ...
                                   <p class="error-file" id="error-file-text2"></p>
										<a class="btn btn-success" onclick="uploadQuestions()" id="upload-btn" style="width:200px;">Upload</a>
											<div class="modal bs-example-modal-lg fade" id="basicModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
													...
													<div class="modal-content" id="modalContent">
														...
														<div class="modal-footer">
                                                           <div class="row">
                                                                    ...
                                                                    <button type="button" style="margin-right: 10px;"class="btn btn-primary" onclick="validateQuestions()">Post quiz</button>
                                                            </div>
														</div>
													</div>
												</div>
