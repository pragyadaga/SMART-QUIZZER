...
if($in_login=="yes"){
    ...
    $result=mysqli_query($conn,"SELECT s_name, email FROM student WHERE USN='$st_id'");
    $row=mysqli_fetch_array($result);
    $st_name=$row['s_name'];
    $st_email=$row['email'];
}
...
if($st_login=="yes"){ //////////////// If the student has logged in
echo <<<EOL
						...
						<div class="panel-body">
							...
							<div class="col-sm-9 tabwrapper">
                               ...
                               <div class="col-sm-8" style="margin-top: 30px; margin-bottom:215px;">                      
                                  ...
                                  <a class="list-group-item">
                                    Student ID : <b>$st_id</b>
                                  </a>
                                  <a class="list-group-item">
                                    Email ID : <b>$st_email</b>
                                  </a>
                                </div></div></div>
...
else if($in_login=="yes"){ //////////////// If the instructor has logged in
   echo <<<EOL
